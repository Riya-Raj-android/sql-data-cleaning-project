...
-- created new table so that the original table should not get affected in order to get data from it whener needed.
...
select *
from layoffs_staging2 where country like 'United States%' order by 1;
